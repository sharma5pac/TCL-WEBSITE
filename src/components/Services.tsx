...
const services = [
    { title: "Network Infrastructure", description: "Design, implementation, and management of robust enterprise networks.", icon: Server, color: "text-blue-400" },
    ...
    { title: "Electrical Installation", description: "Certified professional electrical setups for commercial and residential.", icon: Zap, color: "text-yellow-400" },
    { title: "Home Automation", description: "Smart technologies to automate your environment for comfort and efficiency.", icon: Home, color: "text-green-400" },
